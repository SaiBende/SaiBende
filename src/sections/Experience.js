    ...
    return (
        ...
        <>  <section id='Experience' className='experience bg-black w-full'>
            <div class="bg-black flex flex-col justify-center items-center w-full  p-5">
                ...
                <div class='flex flex-col items-center justify-between bg-black dark:bg-black-800 shadow-md shadow-gray-300 text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-gray-600 w-full md:w-8/12 mx-auto h-auto rounded-xl transition-all ease-in-out duration-500 mb-4 py-2 px-2 md:px-4'>
